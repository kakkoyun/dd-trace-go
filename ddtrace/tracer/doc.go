...
// visualize.
//
// See the contrib package ( https://pkg.go.dev/github.com/kakkoyun/dd-trace-go/v2/contrib )
...
// (See the net/http contrib package for more examples https://pkg.go.dev/github.com/kakkoyun/dd-trace-go/contrib/net/http/v2):
//
...
// https://godoc.org/github.com/kakkoyun/dd-trace-go/v2/contrib
package tracer // import "github.com/kakkoyun/dd-trace-go/v2/ddtrace/tracer"
