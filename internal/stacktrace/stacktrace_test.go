...
func TestStackTraceCurrentFrame(t *testing.T) {
	...
	require.Equal(t, "github.com/kakkoyun/dd-trace-go/v2/internal/stacktrace", frame.Namespace)
...
func TestTruncatedStack(t *testing.T) {
	...
	require.Equal(t, "github.com/kakkoyun/dd-trace-go/v2/internal/stacktrace", lambdaFrame.Namespace)
	...
	for i := 1; i < defaultMaxDepth-defaultTopFrameDepth; i++ {
		...
		require.Equal(t, "github.com/kakkoyun/dd-trace-go/v2/internal/stacktrace", stack[i].Namespace)
...
func TestParseSymbol(t *testing.T) {
	for _, test := range []struct {
		...
		{"method-receiver-pointer", "github.com/kakkoyun/dd-trace-go/v2/internal/stacktrace.(*Test).Method", symbol{
			"github.com/kakkoyun/dd-trace-go/v2/internal/stacktrace",
			"*Test",
			"Method",
		}},
		{"method-receiver", "github.com/kakkoyun/dd-trace-go/v2/internal/stacktrace.(Test).Method", symbol{
			"github.com/kakkoyun/dd-trace-go/v2/internal/stacktrace",
			"Test",
			"Method",
		}},
		{"sample", "github.com/kakkoyun/dd-trace-go/v2/internal/stacktrace.TestGetPackageFromSymbol", symbol{
			"github.com/kakkoyun/dd-trace-go/v2/internal/stacktrace",
			"",
			"TestGetPackageFromSymbol",
		}},
		{"lambda", "github.com/kakkoyun/dd-trace-go/v2/internal/stacktrace.TestGetPackageFromSymbol.func1", symbol{
			"github.com/kakkoyun/dd-trace-go/v2/internal/stacktrace",
			"",
